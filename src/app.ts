...
const mongoDbUriConnect: string =
  "mongodb://admin:vadim1@ds247330.mlab.com:47330/easy-links-db";
...
app.get(
  `${API_PREFIX_ES_LINK}/redirect-es-link/:hash`,
  LinkController.redirectEasyLinkByHash
);
